...
class TrainsTableSeeder extends Seeder
{
    ...
    {
        for ($i=0; $i < 30 ; $i++) { 
            $new_train_object = new Trains();
            $new_train_object->azienda = $faker->sentence(4, true);
            $new_train_object->stazione_di_partenza = $faker->sentence(2, true);
            $new_train_object->stazione_di_arrivo = $faker->sentence(2, true);
